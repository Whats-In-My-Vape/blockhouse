...
//            foundBlockhouse.rating = blockhouse.rating
            ...
            db.child("users").child(userId).child("blockhouses").child(blockhouse.fbId).setValue(blockhouse)
        ...
        fun fetchBlockhouses( blockhousesReady: () -> Unit) {
            val valueEventListener = object : ValueEventListener {
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    dataSnapshot!!.children.mapNotNullTo(blockhouses) { it.getValue<BlockhouseModel>(BlockhouseModel::class.java) }
                    blockhousesReady()
                }
            }
            ...
            blockhouses.clear()
            db.child("users").child(userId).child("blockhouses").addListenerForSingleValueEvent(valueEventListener)
